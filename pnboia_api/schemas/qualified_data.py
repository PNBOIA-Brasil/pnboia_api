...
class QualifiedDataPetrobrasBase(BaseModel):
    ...
    HMS_WIND_RAJADA1: Optional[float] = None
    flag_HMS_WIND_RAJADA1: Optional[int] = None
    HMS_WIND_RAJADA2: Optional[float] = None
    flag_HMS_WIND_RAJADA2: Optional[int] = None
    ...
    ONDA_ALTURAMAX_SENSOR1: Optional[float] = None
    flag_ONDA_ALTURAMAX_SENSOR1: Optional[int] = None
    ONDA_DIRECAOMED_SENSOR1: Optional[int] = None
    flag_ONDA_DIRECAOMED_SENSOR1: Optional[int] = None
    ONDA_ESPALHAMENTO1: Optional[int] = None
    flag_ONDA_ESPALHAMENTO1: Optional[int] = None
...
class QualifiedDataBase(BaseModel):
    ...
    cspd19: Optional[float] = None
    flag_cspd19: Optional[int] = None
    cdir19: Optional[int] = None
    flag_cdir19: Optional[int] = None
    cspd20: Optional[float] = None
    flag_cspd20: Optional[int] = None
    cdir20: Optional[int] = None
    flag_cdir20: Optional[int] = None
...
class QualifiedDataBaseAlias(BaseModel):
...
class BMOBrQualifiedSchema(BaseModel):
...
class PNBoiaQualifiedSchema(BaseModel):
